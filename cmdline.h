...
#define CMDLINE_PARSER_VERSION "0.11.4"
#endif
...
struct gengetopt_args_info
{
  ...
  int log_stdout_flag;	/**< @brief Log to stdout, even when the process is daemonized (default=off).  */
  const char *log_stdout_help; /**< @brief Log to stdout, even when the process is daemonized help description.  */
  ...
  char * cwd_path_arg;	/**< @brief Working directory for Janus daemon process (default=/).  */
  char * cwd_path_orig;	/**< @brief Working directory for Janus daemon process (default=/) original value given at command line.  */
  const char *cwd_path_help; /**< @brief Working directory for Janus daemon process (default=/) help description.  */
  ...
  char * nat_1_1_arg;	/**< @brief Comma-separated list of public IPs to put in all host candidates, assuming a 1:1 NAT is in place (e.g., Amazon EC2 instances, default=none).  */
  char * nat_1_1_orig;	/**< @brief Comma-separated list of public IPs to put in all host candidates, assuming a 1:1 NAT is in place (e.g., Amazon EC2 instances, default=none) original value given at command line.  */
  const char *nat_1_1_help; /**< @brief Comma-separated list of public IPs to put in all host candidates, assuming a 1:1 NAT is in place (e.g., Amazon EC2 instances, default=none) help description.  */
  int keep_private_host_flag;	/**< @brief When nat-1-1 is used (e.g., Amazon EC2 instances), don't remove the private host, but keep both to simulate STUN (default=off).  */
  const char *keep_private_host_help; /**< @brief When nat-1-1 is used (e.g., Amazon EC2 instances), don't remove the private host, but keep both to simulate STUN help description.  */
  ...
  int ipv6_candidates_flag;	/**< @brief Whether to enable IPv6 candidates or not (default=off).  */
  const char *ipv6_candidates_help; /**< @brief Whether to enable IPv6 candidates or not help description.  */
  int ipv6_link_local_flag;	/**< @brief Whether IPv6 link-local candidates should be gathered as well (default=off).  */
  const char *ipv6_link_local_help; /**< @brief Whether IPv6 link-local candidates should be gathered as well help description.  */
  ...
  int slowlink_threshold_arg;	/**< @brief Number of lost packets (per s) that should trigger a 'slowlink' Janus API event to users.  */
  char * slowlink_threshold_orig;	/**< @brief Number of lost packets (per s) that should trigger a 'slowlink' Janus API event to users original value given at command line.  */
  const char *slowlink_threshold_help; /**< @brief Number of lost packets (per s) that should trigger a 'slowlink' Janus API event to users help description.  */
  ...
  unsigned int log_stdout_given ;	/**< @brief Whether log-stdout was given.  */
  ...
  unsigned int keep_private_host_given ;	/**< @brief Whether keep-private-host was given.  */
  ...
  unsigned int ipv6_link_local_given ;	/**< @brief Whether ipv6-link-local was given.  */
